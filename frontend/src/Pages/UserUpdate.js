...
function UserUpdate() {
    const {
        state: { passwordCheck, image: defaultImage },
    } = useLocation();
    ...
    useEffect(() => {
        ...
        } else if (sessionStorage.getItem("category") === "planner" && path.indexOf("user/userupdate") !== -1) {
    ...
    const onChange = (e) => {
        ...
        if (e.target.id === "password") {
            ...
            if (CareerRegExp.test(e.target.value) && parseInt(e.target.value) >= 0 && parseInt(e.target.value) <= 30) {
    ...
    return (
        <div className="containerbox">
            <div class="mainlayout box1" style={{ minHeight: "100vh", height: "100%" }}>
