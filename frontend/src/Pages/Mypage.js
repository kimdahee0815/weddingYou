...
function Mypage() {
    ...
    useEffect(() => {
        ...
        if (category !== "user" && category !== "planner") {
            navigate("/*");
        } else if (sessionStorage.getItem("category") !== "user" && sessionStorage.getItem("category") !== "planner") {
            navigate("/*");
        } else if (sessionStorage.getItem("category") === "user" && path.indexOf("planner") !== -1) {
            navigate("/mypageabc");
        } else if (sessionStorage.getItem("category") === "planner" && path.indexOf("user") !== -1) {
            navigate("/mypageabc");
        }
    }, []);
    ...
    return (
        <div className="containerbox">
            <div className="mainlayout box1" style={{ minHeight: "100vh", height: "100%" }}>
                    ...
                    >
                        ...
                        <form style={{ marginTop: "20px" }}>
                            ...
                            >
                                ...
                                <div className=" mb-4" style={{ width: "250px", marginRight: "20px" }}>
                                    <input
                                        type="text"
                            ...
                            >
                                ...
                                <div className="has-validation  mb-4" style={{ width: "250px", marginRight: "20px" }}>
                                    <input
                                        type="text"
                                        className="form-control "
                                        id="password"
                            ...
                            >
                                ...
                                <div class="input-group" style={{ width: "250px", marginRight: "20px" }}>
                            ...
                            {category === "planner" ? (
                                <div style={{ height: "300px" }}>
                                    ...
                                    >
                                        ...
                                        <div class="has-validation " style={{ width: "250px", marginRight: "20px" }}>
                                            <input
                                                type="number"
                                                class="form-control "
                                                id="career"
