...
const EstimateForm = () => {
    ...
    const budgetSelect = (e) => {
        ...
        const newValue = e.target.value.replace(/\D/g, "").replace(budgetRegex, ",");
        setbudget(newValue);
    };
    ...
    const increasebudget1 = (value) => {
        ...
        const newValue = (val + value).toString().replace(/\D/g, "").replace(budgetRegex, ",");
        setbudget(newValue);
    };
    ...
    //JSON 변환
    let submitdate = JSON.stringify([weddingdate.datefirst, weddingdate.datesecond, weddingdate.datethird]);
    ...
    const onSubmit = () => {
        ...
        if (weddingdate.datefirst === weddingdate.datesecond || weddingdate.datefirst === weddingdate.datethird) {
    ...
    return (
        <div className="containerbox">
            ...
            /> */}
                        ...
                        <div className="choosebox">
                            <span>Priority 2</span>
                            <RegionList name="regionsecond" weddingregionSelect={weddingregionSelect} />
                        </div>
                        <div className="choosebox">
                            <span>Priority 3</span>
                            <RegionList name="regionthird" weddingregionSelect={weddingregionSelect} />
                        </div>
                    </div>
                    <div className="contentbox">
                        <h5>Budget</h5>
                    ...
                    <div className="contentbox">
                        <h5>Attach Images</h5>
                        <div className="choosebox" style={{ display: "inline-block", width: "100%" }}>
                            <input
                                type="file"
                                multiple
...
const AccordionComp = ({ heading, collapse, topic, image1, image2, image3, comment1, comment2, comment3, _id }) => {
    return (
                ...
                <div className="accordion-body p-0">
                    <div className="exampleimagebox">
                        <div className="exampleimage">
                            <Carousel image1={image1} image2={image2} image3={image3} heading={heading} />
                        </div>
                    </div>
        ...
        >
            ...
            <div className="carousel-inner">
                <div className="carousel-item active" data-bs-interval="10000">
                    <img src={image1} className="d-block w-100" style={{ height: 450 }} alt="..." />
                    <div className="carousel-caption d-none d-md-block"></div>
                </div>
                <div className="carousel-item" data-bs-interval="2000">
                    <img src={image2} className="d-block w-100" style={{ height: 450 }} alt="..." />
                    <div className="carousel-caption d-none d-md-block"></div>
                </div>
                <div className="carousel-item">
                    <img src={image3} className="d-block w-100" style={{ height: 450 }} alt="..." />
                    <div className="carousel-caption d-none d-md-block"></div>
                </div>
            </div>
            <button
