...
function Review() {
    ...
    const fetchData = async (selectedEstimateId) => {
        try {
            const response = await axios.get(`/estimate/detail/${selectedEstimateId}`);
            const { data } = response;
            // console.log(data);
        ...
        axios.post(`/existreviewpaid`, formData).then((res) => {
            ...
            if (res.data.length !== 0) {
                ...
                const fetchData1 = async () => {
                    try {
                        const response = await axios.get(`/estimate/detail/${defaultEstimateId}`);
                        const { data } = response;
                        //console.log(data);
                        SetEstimateData(data);
                        if (data.userMatching === null) {
                ...
                <div style={{ marginTop: 75 }}>
                    <div class="dropdown  right-sort">
                        ...
                        <ul class="dropdown-menu sortItem">
                            ...
                            <li>
                                <button class="dropdown-item" type="button" onClick={() => handleSortClick("By Views")}>
                                    By Views
                                </button>
                            </li>
                            <li className="">
                                <button class="dropdown-item " type="button" onClick={() => handleSortClick("Latest")}>
                                    Latest
                                </button>
                            </li>
                        </ul>
                                            ...
                                            <div className="contentcontainer-detail">
                                                ...
                                                <div className="contentbox-detail">
                                                    {images?.length === 0 ? (
                                                        ...
                                                        <h5 style={{ marginTop: "-20px" }}>고객 첨부이미지 </h5>
                                                    )}
