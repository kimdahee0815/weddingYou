    ...
    return (
        <div className="containerbox">
            <div className="mainlayout box1">
                ...
                <br />
                <div className="container text-center" style={{ marginTop: "100px", height: "700px" }}>
                    <div className="row">
                        ...
                        <div className="col-8">
                            <div className="infotext3">
                                <button
                                    ...
                                    onClick={onClicksend}
                                    style={{ fontSize: "1.2em", height: "70px" }}
                                >
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <div className="infotext4">
                                    <i className="bi bi-dash-lg"></i>&nbsp;&nbsp;
                                    <span style={{ fontSize: "1.3em" }}>Temporary Password Sent Successfully</span>
                                    &nbsp;&nbsp;
                                    <i className="bi bi-dash-lg"></i>
                                </div>
                            </div>
